...
<body>
        <form class="form" method="post" action="/loginfuncionario/cadastro-reserva" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card">
            ...
            <div class="campo">
                ...
                <input type="text" class="nome" name="user_nome" id="user_nome" required>
            </div>
            ...
            <div class="campo">
                ...
                <input type="text" class="idproduto" name="idproduto" value="{{ $produto->id }}" required>
            </div>

            <!-- Campo do nome do produto -->
            <div class="campo">
                <label for="produtoname"><strong>Nome do produto:</strong></label>
                <input type="text" class="produtoname" name="produtoname" value="{{ $produto->NomeProduto }}" required>
            </div>
